...
[a,b21,c21]=a_median(tod,Zn_ICPMS_ugm3',2);

[a,b22,c22]=a_median(tod,SO2_ppb,2);
...
[a,b22,c22]=a_median(tod(doy_merge<410),SO2_ppb(doy_merge<410),2);
figure
subplot(4,4,1)
plot(a,b1,'k.-')
ylabel('sulfate')
...
figure
scatter(pm25_ugm3(doy_merge<410),sulfate_ugm3(doy_merge<410).*0.0172./0.672, 30,t_merge(doy_merge<410),'filled'); grid;colorbar;title('Jan');ylabel('sulfate');xlabel('PM2.5');
%provided by ragen
%Jan *0.0172./0.672
%Feb *0.014./0.76266
figure
scatter(pm25_ugm3(doy_merge>410),sulfate_ugm3(doy_merge>410), 30,t_merge(doy_merge>410),'filled'); grid;colorbar;title('Feb');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge<410),sulfate_ugm3(doy_merge<410), 30,O3_ppb(doy_merge<410),'filled'); grid;colorbar;title('Jan');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge>410),sulfate_ugm3(doy_merge>410), 40,O3_ppb(doy_merge>410),'filled'); grid;colorbar;title('Feb');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge<410),sulfate_ugm3(doy_merge<410), 30,SO2_ppb(doy_merge<410),'filled'); grid;colorbar;title('Jan');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge>410),sulfate_ugm3(doy_merge>410), 30,SO2_ppb(doy_merge>410),'filled'); grid;colorbar;title('Feb');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge<410),SO2_ppb(doy_merge<410), 30,t_merge(doy_merge<410),'filled'); grid;colorbar;title('Jan');ylabel('SO2');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge>410),SO2_ppb(doy_merge>410), 30,t_merge(doy_merge>410),'filled'); grid;colorbar;title('Feb');ylabel('SO2');xlabel('PM2.5');

figure
scatter(pm25_ugm3,SO2_ppb, 30,t_merge,'filled'); grid;colorbar;title('Jan Feb');ylabel('SO2');xlabel('PM2.5');

figure
scatter(sulfate_ugm3(doy_merge<410),Fe_ICPMS_ugm3(doy_merge<410), 30,t_merge(doy_merge<410),'filled'); grid;colorbar;title('Jan');ylabel('Fe');xlabel('SO4');
%provided by ragen