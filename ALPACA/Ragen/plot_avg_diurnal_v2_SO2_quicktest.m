...
figure
scatter(pm25_ugm3(doy_merge<400),sulfate_ugm3(doy_merge<400).*0.0172./0.672, 30,t_merge(doy_merge<400),'filled'); grid;colorbar;title('Jan');ylabel('sulfate');xlabel('PM2.5');
%provided by ragen
%Jan *0.0172./0.672
%Feb *0.014./0.76266
figure
scatter(pm25_ugm3(doy_merge>400),sulfate_ugm3(doy_merge>400), 30,t_merge(doy_merge>400),'filled'); grid;colorbar;title('Feb');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge<400),sulfate_ugm3(doy_merge<400), 30,O3_ppb(doy_merge<400),'filled'); grid;colorbar;title('Jan');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge>400),sulfate_ugm3(doy_merge>400), 40,O3_ppb(doy_merge>400),'filled'); grid;colorbar;title('Feb');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge<400),sulfate_ugm3(doy_merge<400), 30,SO2_ppb(doy_merge<400),'filled'); grid;colorbar;title('Jan');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge>400),sulfate_ugm3(doy_merge>400), 30,SO2_ppb(doy_merge>400),'filled'); grid;colorbar;title('Feb');ylabel('sulfate');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge<400),SO2_ppb(doy_merge<400), 30,t_merge(doy_merge<400),'filled'); grid;colorbar;title('Jan');ylabel('SO2');xlabel('PM2.5');

figure
scatter(pm25_ugm3(doy_merge>400),SO2_ppb(doy_merge>400), 30,t_merge(doy_merge>400),'filled'); grid;colorbar;title('Feb');ylabel('SO2');xlabel('PM2.5');

figure
scatter(pm25_ugm3,SO2_ppb, 30,t_merge,'filled'); grid;colorbar;title('Jan Feb');ylabel('SO2');xlabel('PM2.5');

figure
scatter(sulfate_ugm3(doy_merge<400),Fe_ICPMS_ugm3(doy_merge<400), 30,t_merge(doy_merge<400),'filled'); grid;colorbar;title('Jan');ylabel('Fe');xlabel('SO4');
%provided by ragen