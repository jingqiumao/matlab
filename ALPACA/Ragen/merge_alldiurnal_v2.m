...
%Jan *0.0172./0.672
%Feb *0.014./0.76266
sulfate_ugm3=sulfate_merge;
sulfate_ugm3(doy_merge<410)=sulfate_merge(doy_merge<410).*0.0172./0.672;
sulfate_ugm3(doy_merge>=410)=sulfate_merge(doy_merge>=410).*0.014./0.76266;

nitrate_ugm3=nitrate_merge;
nitrate_ugm3(doy_merge<410)=nitrate_merge(doy_merge<410).*0.0172./0.672;
nitrate_ugm3(doy_merge>=410)=nitrate_merge(doy_merge>=410).*0.014./0.76266;

ammonium_ugm3=ammonium_merge;
ammonium_ugm3(doy_merge<410)=ammonium_merge(doy_merge<410).*0.0172./0.672;
ammonium_ugm3(doy_merge>=410)=ammonium_merge(doy_merge>=410).*0.014./0.76266;

NOy_ppb=NOy_merge;
pm25_ugm3=pm25_merge;
CO_ppb=CO_merge;
SO2_ppb=SO2_merge;
O3_ppb=O3_merge;

chloride_ugm3=chloride_merge;
chloride_ugm3(doy_merge<410)=chloride_merge(doy_merge<410).*0.0172./0.672;
chloride_ugm3(doy_merge>=410)=chloride_merge(doy_merge>=410).*0.014./0.76266;

Na_IC_ugm3=Na_IC_merge;
Na_IC_ugm3(doy_merge<410)=Na_IC_merge(doy_merge<410).*0.0172./0.672;
Na_IC_ugm3(doy_merge>=410)=Na_IC_merge(doy_merge>=410).*0.014./0.76266;

K_IC_ugm3=K_IC_merge;
K_IC_ugm3(doy_merge<410)=K_IC_merge(doy_merge<410).*0.0172./0.672;
K_IC_ugm3(doy_merge>=410)=K_IC_merge(doy_merge>=410).*0.014./0.76266;

Ca_IC_ugm3=Ca_IC_merge;
Ca_IC_ugm3(doy_merge<410)=Ca_IC_merge(doy_merge<410).*0.0172./0.672;
Ca_IC_ugm3(doy_merge>=410)=Ca_IC_merge(doy_merge>=410).*0.014./0.76266;

Mg_IC_ugm3=Mg_IC_merge;
Mg_IC_ugm3(doy_merge<410)=Mg_IC_merge(doy_merge<410).*0.0172./0.672;
Mg_IC_ugm3(doy_merge>=410)=Mg_IC_merge(doy_merge>=410).*0.014./0.76266;

Na_ICPMS_ugm3=Na_ICPMS_merge;
Na_ICPMS_ugm3(doy_merge<410)=Na_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Na_ICPMS_ugm3(doy_merge>=410)=Na_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

K_ICPMS_ugm3=K_ICPMS_merge;
K_ICPMS_ugm3(doy_merge<410)=K_ICPMS_merge(doy_merge<410).*0.0172./0.672;
K_ICPMS_ugm3(doy_merge>=410)=K_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

Ca_ICPMS_ugm3=Ca_ICPMS_merge;
Ca_ICPMS_ugm3(doy_merge<410)=Ca_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Ca_ICPMS_ugm3(doy_merge>=410)=Ca_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

Mg_ICPMS_ugm3=Mg_ICPMS_merge;
Mg_ICPMS_ugm3(doy_merge<410)=Mg_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Mg_ICPMS_ugm3(doy_merge>=410)=Mg_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

Mn_ICPMS_ugm3=Mn_ICPMS_merge;
Mn_ICPMS_ugm3(doy_merge<410)=Mn_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Mn_ICPMS_ugm3(doy_merge>=410)=Mn_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

Fe_ICPMS_ugm3=Fe_ICPMS_merge;
Fe_ICPMS_ugm3(doy_merge<410)=Fe_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Fe_ICPMS_ugm3(doy_merge>=410)=Fe_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

Cu_ICPMS_ugm3=Cu_ICPMS_merge;
Cu_ICPMS_ugm3(doy_merge<410)=Cu_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Cu_ICPMS_ugm3(doy_merge>=410)=Cu_ICPMS_merge(doy_merge>=410).*0.014./0.76266;

Zn_ICPMS_ugm3=Zn_ICPMS_merge;
Zn_ICPMS_ugm3(doy_merge<410)=Zn_ICPMS_merge(doy_merge<410).*0.0172./0.672;
Zn_ICPMS_ugm3(doy_merge>=410)=Zn_ICPMS_merge(doy_merge>=410).*0.014./0.76266;
save merge_diurnal_v3 pm25_ugm3 sulfate_ugm3 nitrate_ugm3 ammonium_ugm3 doy_merge t_merge NOy_ppb CO_ppb SO2_ppb O3_ppb...
    chloride_ugm3 Na_IC_ugm3 K_IC_ugm3 Ca_IC_ugm3 Mg_IC_ugm3...
    Na_ICPMS_ugm3 K_ICPMS_ugm3 Ca_ICPMS_ugm3 Mg_ICPMS_ugm3 Mn_ICPMS_ugm3 Fe_ICPMS_ugm3 Cu_ICPMS_ugm3 Zn_ICPMS_ugm3;

figure
scatter(pm25_ugm3,sulfate_ugm3.*0.017./0.672, 30,t_merge,'filled'); grid;colorbar;ylabel('sulfate');xlabel('PM2.5');

figure
scatter(NOy_ppb,sulfate_ugm3.*0.017./0.672, 30,t_merge,'filled'); grid;colorbar;