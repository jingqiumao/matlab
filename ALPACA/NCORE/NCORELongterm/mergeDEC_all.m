[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2013.csv');
...
keep time_local1 PM251 ambT1 sulfate1 nitrate1 cholride1 ammonium1 ...
    Fe1 Cu1 Mn1 Ba1 Sr1 Zn1 Na_IC1 Na1 K_IC1 K1 Mg1 Ca1 S_XRF1 Cl_XRF1 OC1 EC1;

[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2014.csv');
...
keep time_local_merge ambT_merge PM25_merge sulfate_merge nitrate_merge cholride_merge ammonium_merge...
    Fe_merge Cu_merge Mn_merge Ba_merge Sr_merge Zn_merge Na_IC_merge Na_merge K_IC_merge K_merge Mg_merge Ca_merge S_XRF_merge Cl_XRF_merge EC_merge OC_merge;

[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2015.csv');
...
EC_merge=[EC_merge; EC];
OC_merge=[OC_merge; OC];
keep time_local_merge ambT_merge PM25_merge sulfate_merge nitrate_merge cholride_merge ammonium_merge...
    Fe_merge Cu_merge Mn_merge Ba_merge Sr_merge Zn_merge Na_IC_merge Na_merge K_IC_merge K_merge Mg_merge Ca_merge S_XRF_merge Cl_XRF_merge EC_merge OC_merge;

[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2016.csv');
time_local_merge=[time_local_merge; time_local];
PM25_merge=[PM25_merge; PM25]; 
sulfate_merge=[sulfate_merge; sulfate]; 
nitrate_merge=[nitrate_merge; nitrate];
...
[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2017.csv');
time_local_merge=[time_local_merge; time_local];
PM25_merge=[PM25_merge; PM25]; 
sulfate_merge=[sulfate_merge; sulfate]; 
nitrate_merge=[nitrate_merge; nitrate];
...
[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2018.csv');
time_local_merge=[time_local_merge; time_local];
PM25_merge=[PM25_merge; PM25]; 
sulfate_merge=[sulfate_merge; sulfate]; 
nitrate_merge=[nitrate_merge; nitrate];
...
[time_local,ambT, PM25, sulfate, nitrate,cholride,ammonium,Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC('Inorganic2019.csv');
time_local_merge=[time_local_merge; time_local];
PM25_merge=[PM25_merge; PM25]; 
sulfate_merge=[sulfate_merge; sulfate]; 
nitrate_merge=[nitrate_merge; nitrate];
...
function [time_local,ambientT, PM25_FRM, sulfate, nitrate,chloride,ammonium, Fe, Cu, Mn,Ba,Sr,Zn,Na_IC,Na,K_IC,K,Mg,Ca,S_XRF,Cl_XRF, EC, OC]=readDEC(filename)
...
indx=find(state_code==02 & county_code ==90 & site_number ==034 & parameter_code==88370 & (month==11|month==12|month==1|month==2));
OC_time=date_local(indx);
OC=sample_measurement(indx);
    for i=1:length(sulfate)
        k=find(OC_time==sulfate_time(i));
        if ~isempty(k)
            OC1(i)=OC(k);
        end
    end
...
indx=find(state_code==02 & county_code ==90 & site_number ==034 & parameter_code==88380 & (month==11|month==12|month==1|month==2));
EC_time=date_local(indx);
EC=sample_measurement(indx);
    for i=1:length(sulfate)
        k=find(EC_time==sulfate_time(i));
        if ~isempty(k)
            EC1(i)=EC(k);
        end
    end
