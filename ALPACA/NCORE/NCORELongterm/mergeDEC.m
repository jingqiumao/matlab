...
[time_local,PM25, sulfate, nitrate,cholride,ammonium]=readDEC('Inorganic2012.csv');
...
keep PM251 sulfate1 nitrate1 cholride1 ammonium1;
...
if ~isempty(PM25_time_a)
    PM25_time_final=PM25_time_a;
    PM25_FRM_final=PM25_FRM_a;
...
elseif ~isempty(PM25_time_b)
    PM25_time_final=PM25_time_b;
    PM25_FRM_final=PM25_FRM_b;
else
    PM25_time_final=PM25_time_c;
    PM25_FRM_final=PM25_FRM_c;
end
...
for i=1:length(sulfate_time)
    ...
    if ~isempty(indx)
    PM25_FRM (i) = PM25_FRM_final(indx);
    else
        PM25_FRM (i) = NaN;
    end
end
