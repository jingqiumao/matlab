...
filelist = dir(fullfile(tempdir, 'Pandora29_Fairbanks*.txt'));
...
[mode,time, routine, repet, duration, sza, azimuth, lza, lazimuth, pointz, zmode, pointa,amode,...
    ...
    =textread(filename, '%s %s %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f', 'headerlines',67 );
time=char(time);
year=sza;
month=sza;
day=sza;
...
for i=1:length(time)
    ...
    dateInput = temp(1:8);
    eval(['save ' dateInput '.mat doy mode sza SCD_HCHO SCD_HCHO_u AMF_HCHO SCD_NO2 SCD_NO2_u AMF_NO2 SCD_O3 SCD_O3_u AMF_O3 SCD_SO2 SCD_SO2_u AMF_SO2']);
end
