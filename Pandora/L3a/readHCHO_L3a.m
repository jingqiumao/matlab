file = '../L3a/Pandora29_Fairbanks_20180608_lev3.txt';
...
firstday = 140;
%indx= (doy>firstday & doy <firstday+1 & mode == "SU");
indx= ( mode == "SU");
plot(timeofday(indx), SCD_HCHO(indx),'.-');
xlim([0 24]);
ylim([0 200]);
...
figure;
plot(timeofday(indx), SCD_HCHO(indx)./AMF_HCHO(indx),'.-');
xlim([0 24]);
ylim([0 10]);
set(gca,'XTick',[0 6 12 18 24],'XTickLabel',[' 0:00';' 6:00';'12:00';'18:00';' 0:00']);
title('HCHO_VCD')
...
figure;
plot(timeofday(indx), SCD_HCHO_u(indx),'.-');
xlim([0 24]);
%ylim([0 1200]);
set(gca,'XTick',[0 6 12 18 24],'XTickLabel',[' 0:00';' 6:00';'12:00';'18:00';' 0:00']);
title('HCHO_uncertainty')
