file = 'Pandora29_Fairbanks_NO2_FW2.txt';
[time,duration,sza, azimuth, rms, rms_resid,VCD, VCD_u, AMF, sum, eff_temp, stray, w_shift, wheel, fitting, NO2_temp, NO2_temp_u]...
