...
% errorbar(a,b1,c1/2,'k','linewidth',2)
hold on;
b1(b1<0)=NaN;
% plot(a,b11,'bo-',a,b1,'ko-',a,b2,'g.-',a,b3,'y.-',a,b4,'m.-',a,b5,'r.-','linewidth',2)
%here 0.8 is to account for the factor f (08/06/2012)
b1=b1*0.8;
plot(a,b11,'b.-',a,b1,'k.-',a,b5,'r.-','linewidth',2)
