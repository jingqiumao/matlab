...
load C:\mao\mypapers\BEARPEX\paper\USQT\mrg_BEARPEX2009_obs_mod_10min_20110916_slower_USQT_100times.mat
...
b2(b2<0)=NaN;
% h=plot(a1,b1,'bo-',a2,b2,'ko-',a3,b3,'g.-',a4,b4,'r.-',a5,b5,'m.-',a6,b6,'m--','linewidth',2);
h=plot(a1,b1,'b.-',a2,b2,'k.-',a6,b6,'r.-','linewidth',2);
hold on;
errorbar(a2,b2,b2*0.5,'k','linewidth',2)
xlim([xmin xmax]);
ylim([-0.05 0.35]);
grid on;
...
% h=plot(a1,b1,'bo-',a3,b3,'g.-',a4,b4,'r.-',a5,b5,'m.-',a6,b6,'m--','linewidth',2);
...
%plot OHR
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load C:\mao\mypapers\BEARPEX\paper\OHR_mod.mat
tod=doy2009-floor(doy2009);


% load HOx_bearpex09_merge_mao_20110608
% load HOx_bearpex09_brune_merge_20110610
load C:\mao\mypapers\BEARPEX\paper\HOx_OHR_BPX09_10min_20110608
hour=DOY-floor(DOY);
OHR_zero=1.5;
...
% daytimeratio=b2;
subplot(3,1,3)
% h=plot (a1,b1,'bo-',a2,b2,'g.-',a3,b3,'r.-',a4,b4,'m.-',a4,b4a,'m--',a5,b5,'y.-','linewidth',2);
